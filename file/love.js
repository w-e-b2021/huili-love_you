;(function (window) {
  var branchAndGroundColor = '#3fc7ff'
  ...
  Footer.prototype = {
    draw: function () {
      ...
      ctx.strokeStyle = branchAndGroundColor
  ...
  Branch.prototype = {
    ...
    draw: function (p) {
      ...
      ctx.save()
      ctx.beginPath()
      ctx.fillStyle = branchAndGroundColor
      ctx.strokeStyle = branchAndGroundColor
      ctx.moveTo(p.x, p.y)
